      ...
      <div className="loginBox">
        ...
        <div className="loginMain">
          ...
          <div className="loginBtn">
            <Button type="primary" onClick={this.submitLogin.bind(this)}>注册</Button>
            <Button type="primary" className="register_button" onClick={this.submitLogin.bind(this)}>已有账户</Button>
          </div>
        </div>
      </div>
    )
